...
do
    ...
    menu = library.new([[witch <font color="rgb(78, 93, 234)">universal</font>]], "nemv2\\") //78, 93, 234
    local tabs = {
    ...
    do
        ...
        assist.element("Slider", "smoothing", {default = {min = 0, max = 50, default = 1}})
    ...
    do
        ...
        self.element("Slider", "distance", {default = {min = 1, max = 20, default = 15}})
